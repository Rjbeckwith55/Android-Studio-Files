        ...
        try {
            ...
            for (int r = 0; r < rows.length(); ++r) {
                ...
                String westerneastern = columns.getJSONObject(7).getString("v");
                 Transfers m = new Transfers(symbol,name,code,cod,uiucsymbol,uiuccode,ssHum,westerneastern);
                transferArray.add(m);
            }

            final TransfersAdapter adapter = new TransfersAdapter(this, R.layout.transfers, transferArray);
